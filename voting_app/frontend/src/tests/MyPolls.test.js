...
describe('MyPollsContainer', () => {
    ...
    beforeEach(() => {
        wrapper = shallow(<MyPollsContainer location={pathname} />);
        api.fetchMyPolls.mockImplementation(() => {
